...
/*
Having a local copy of CardsDTO file in Accounts service for use in FeignClient response after invoking
Cards REST API. Having a copy instead of import from Cards (adding Cards as a dependency in Maven)
to keep microservices independent and de-couple from build-time dependency. Allows independent releases of each service.
 */
